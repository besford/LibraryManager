...
public class OutputHandler {
	...
	public Output createUser(String input) {
        ...
        if (strArray.length != 2 || email != true) {
        	...
        	result = UserTable.instanceOf().createUser(strArray[0], strArray[1]);
	...
	public Output createTitle(String input) {
        ...
        if (strArray.length != 2 || number != true) {
        	...
        	result = TitleTable.instanceOf().createtitle(strArray[0], strArray[1]);
        	if (result.equals(true))
        		output.setOutput("Success!");
        	else
	...
	public Output createItem(String input) {
        ...
        if (strArray.length != 1 || number != true) {
        	...
        	result = ItemTable.instanceOf().createItem(strArray[0]);
        	if (result.equals(true)) 
        		output.setOutput("Success!");
        	else
	...
	public Output deleteUser(String input) {
		Output output = ew Output("",0);
		String[] strArray = null;   
        strArray = input.split(",");
        int userid = UserTable.instanceOf().lookUp(strArray[0]);
        boolean email = strArray[0].contains("@");
        Object result = "";
        if (strArray.length != 1 || email != true) {
        	...
        	result = UserTable.instanceOf().delete(userid);
	...
	public Output deleteTitle(String input) {
        ...
        boolean number = isInteger(strArray[0]);
        Object result = "";
        if (strArray.length != 1 || !number) {
        	output.setOutput("Your input should in this format:'ISBN',ISBN should be a 13-digit number");
        	output.setState(DELETETITLE);
		}
		else 
        	result = TitleTable.instanceOf().deleteTitle(strArray[0]);
        	if (result.equals("success"))
        		output.setOutput("Success!");
        	else
				output.setOutput(result+"!");
	...
	public Output deleteItem(String input) {
        ...
        if(strArray.length != 2 || !number) {
        	...
        	if (copynumber != true) {
        		...
        		result = ItemTable.instanceOf().delete(strArray[0], strArray[1]);
            	if(result.equals("success"))
            		output.setOutput("Success!");
            	else
            		output.setOutput(result+"!");
	...
	public Output borrow(String input) {
        ...
        if (strArray.length != 3 || !email) {
        	...
        	if(!ISBN || !copynumber) {
        		...
        		result = LoanTable.instanceOf().createloan(userid, strArray[1], strArray[2], new Date());
        		if (result.equals("success"))
            		output.setOutput("Success!");
            	else
            		output.setOutput(result+"!");
	...
	public Output addLoan(String input) {
		Output output = new Output("",0);
		String[] strArray = null;   
        strArray = input.split(",");
        boolean email = strArray[0].contains("@");
	...
	public Output renew(String input) {
        ...
        if (strArray.length != 3 || !email) {
        	...
        	if (!ISBN || !copynumber) {
        		...
        		result = LoanTable.instanceOf().renewal(userid, strArray[1], strArray[2], new Date());
        		if(result.equals("success"))
            		output.setOutput("Success!");
            	else
            		output.setOutput(result+"!");
	...
	public Output renewLoan(String input) {
        ...
        if (strArray.length != 3 || !email) {
        	output.setOutput("Your input should in this format:'useremail,ISBN,copynumber'");
        	output.setState(CLERKRENEWLOAN);
		}
		else if (userid == -1) {
        	output.setOutput("The User Does Not Exist!");
        	output.setState(CLERKRENEWLOAN);
	...
	public Output returnBook(String input) {
        ...
        if(strArray.length != 3 || !email) {
        	...
        	if (!ISBN || !copynumber) {
        		...
        		result = LoanTable.instanceOf().returnItem(userid, strArray[1], strArray[2], new Date());
        		if (result.equals("success"))
            		output.setOutput("Success!");
            	else
            		output.setOutput(result+"!");
	...
	public Output removeLoan(String input) {
		Output output = new Output("",0);
		String[] strArray = null;   
        strArray = input.split(",");
        boolean email = strArray[0].contains("@");
        ...
        if (strArray.length != 3 || !email) {
        	output.setOutput("Your input should in this format:'useremail,ISBN,copynumber'");
        	output.setState(CLERKREMOVELOAN);
		}
		else if (userid == -1) {
        	output.setOutput("The User Does Not Exist!");
        	output.setState(CLERKREMOVELOAN);
	...
	public Output payFine(String input) {
        ...
        if (strArray.length != 1 || !email) {
        	...
        	result = FeeTable.instanceOf().payFine(userid);	
        	if (result.equals("success")) 
        		output.setOutput("Success!");
			else
            	output.setOutput(result+"!");
	...
	public Output collectFines(String input) {
		Output output = new Output("", 0);
		String[] strArray = null;   
        strArray = input.split(",");
        boolean email = strArray[0].contains("@");
        ...
        if (strArray.length != 1 || !email) {
        	output.setOutput("Your input should in this format:'useremail'");
        	output.setState(CLERKCOLLECTFINES);
		}
		else if (userid == -1) {
        	output.setOutput("The User Does Not Exist!");
        	output.setState(CLERKCOLLECTFINES);
	...
	public Output clerkLogin(String input) {
		...
		if (input.equalsIgnoreCase(Config.CLERK_PASSWORD)){
			output.setOutput("What can I do for you?Menu:Create User/Title/Item,Delete User/Title/Item,Loan Add/Renew/Remove, Fines Collect.");
        	output.setState(CLERK);
		}
		else {
	...
	public Output userLogin(String input) {
        ...
        boolean email = strArray[0].contains("@");
        int result = 0;
        if (strArray.length != 2 || !email) {
        	output.setOutput("Your input should in this format:'username,password'");
        	output.setState(USERLOGIN);
		} 
		else {
        	result = UserTable.instanceOf().checkUser(strArray[0], strArray[1]);
        	if(result == 0) 
